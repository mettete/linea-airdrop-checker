...
export default function Page() {
  ...
  async function onCheck() {
    ...
    try {
      ...
      if (!r.ok || (j as any).error) throw new Error((j as any).error || r.statusText);
      ...
      if (total > 0) {
        ...
        const confetti = mod.default as any;
  ...
  return (
    <div style={{
      ...
      color: "#e8ecf1", fontFamily: "Inter, ui-sans-serif, system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial"
    }}>
      {/* faint 3D grid */}
      <div style={{
        ...
        backgroundSize: "40px 40px", maskImage: "radial-gradient(ellipse at 50% 50%, black 40%, transparent 70%)"
      }} />
      ...
      <main style={{ maxWidth: 980, margin: "0 auto", padding: "48px 20px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 10 }}>
            ...
            <div style={{
              ...
              <img
                ...
                width={36}
                height={36}
                style={{ display: "block", filter: "drop-shadow(0 2px 6px rgba(0,0,0,.3))" }}
                onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = "none"; }}
              />
            </div>
            <h1 style={{ fontSize: 28, margin: 0, letterSpacing: .3 }}>Linea Airdrop Checker</h1>
            ...
            >
              <svg width="16" height="16" viewBox="0 0 24 24" aria-hidden>
                <path fill="currentColor" d="M18.244 2H21l-6.57 7.51L22 22h-6.81l-5.34-7.22L3.9 22H2l7.05-8.06L2 2h6.89l4.84 6.63L18.244 2Zm-1.19 18h1.83L7.02 4H5.13l11.924 16Z" />
              </svg>
              Follow on X
            </a>
          </div>
          <p style={{ margin: 0, color: "#b9c3cf" }}>
            Paste multiple wallet addresses (comma/space/newline separated). We’ll batch-query the allocation and show per-wallet amounts and the total.
          </p>
        </section>
        ...
        <section style={{
          ...
          <label style={{ display: "block", marginBottom: 8, color: "#cdd7e1", fontWeight: 600 }}>
            Wallet addresses
          </label>
          <textarea
            placeholder={`0xabc...\n0xdef...\n0x123...`}
            ...
            style={{
              width: "100%", height: 160, borderRadius: 16, padding: 14,
              background: "#0f1319", border: "1px solid #263142", color: "#e8ecf1",
              fontFamily: "ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace",
              fontSize: 13, outline: "none", resize: "vertical", boxShadow: "inset 0 0 40px rgba(0,0,0,0.35)"
            }}
          />
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginTop: 12, flexWrap: "wrap" }}>
            <button
              ...
              style={{
                padding: "12px 18px", borderRadius: 14, border: "1px solid #3a4b63",
                background: loading ? "rgba(255,255,255,0.12)" : "linear-gradient(135deg, #7aa7ff, #b78cff)",
                color: "#0b0e12", fontWeight: 800, cursor: loading ? "default" : "pointer",
            ...
            <div style={{ marginLeft: "auto", color: "#93a0af", fontSize: 12 }}>
              {parsedAddresses.length > 0 ? `${parsedAddresses.length} address` : "No addresses"}
            </div>
          </div>
          {err && (
            <div style={{
              marginTop: 10, padding: "10px 12px", borderRadius: 12,
              background: "rgba(255,99,99,0.08)", border: "1px solid rgba(255,99,99,0.3)",
              color: "#ffb3b3", fontSize: 13
            }}>
              {err}
            </div>
          )}
        ...
        {res && (
          <section style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 12, flexWrap: "wrap" }}>
              <div style={{
                padding: "6px 10px", borderRadius: 999, border: "1px solid #35465d", color: "#b9c3cf",
                ...
                <tbody>
                  {Object.entries(res.perWallet).map(([addr, v], idx) => (
                    <tr key={addr} style={{ background: idx % 2 === 0 ? "#0c0f14" : "#0a0d12" }}>
                      ...
                      <td style={{ padding: "10px 12px", fontFamily: "ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace", fontSize: 12, color: "#d6dee8" }}>
                        {addr}
                      </td>
                      ...
                      <td style={{ padding: "10px 12px", textAlign: "center" }}>
                        {v.duplicates > 1 ? (
                          <span style={{
                            ...
                            borderRadius: 999, border: "1px solid #3a4b63", background: "rgba(255,255,255,0.04)",
                            fontSize: 12, color: "#b9c3cf"
                          }}>
                            ×{v.duplicates}
                          </span>
                        ) : (
